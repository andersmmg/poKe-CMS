...
<div class="jumbotron">
  ...
  <hr class="m-y-2">
  <p>It is still in development so do not expect much. This control panel will be much better than the old multisite control panel.</p>
  <p class="lead">
...
<div class="row">
  ...
  <div class="col-sm-6 alert alert-dismissible fade in" role="alert">
    ...
    <div class="card card-block">
      ...
      <p class="card-text">Pages create rich content for a beautiful website.</p>
